...
%   1. no need to crop/scale size of image
...
% file management
subfolder1 = "1280x720\"; 
subfolder2 = "1280x720(colored)\";
checkFolders(saveaddr,subfolder1,subfolder2);
...
for img_idx = 1:numImgFrame
        ...
        imwrite(DepImg, map1, outputFileName1); 
        
        outputFileName2 = strcat(saveaddr,subfolder2,num2str(img_idx),'.png');
        imwrite(DepImg, map2, outputFileName2);
...
function checkFolders(saveaddr,subfolder1,subfolder2)
